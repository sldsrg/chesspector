...
describe(`Moveparser`, function() {
    ...
    describe(`when parse single line of moves recorded in LAN`, () => {
        ...
        beforeAll(()=> {
            let parser = new MoveParser("1.e2-e4 e7-e5 2.Ng1-f3 Nb8-c6 3.Bf1-c4");
            first = parser.parse();
        });
    ...
    describe(`when parse single line of moves recorded in SAN`, () => {
        ...
        beforeAll(()=> {
            let parser = new MoveParser("1.e4 e5 2.Nf3 Nc6 3.Bc4");
            first = parser.parse();
        });
    ...
    describe(`when parse moves with forks`, () => {
        ...
        beforeAll(()=> {
            let parser = new MoveParser("1.e4 e5 2.Nf3 (2.Nc3 Nc6 3.Nf3) Nc6 3.Bc4");
            first = parser.parse();
        });
    ...
    describe(`when parse single line of moves with comment`, () => {
        ...
        beforeAll(()=> {
            let parser = new MoveParser("1.e2-e4 e7-e5 {simple comment} 2.Ng1-f3 Nb8-c6 3.Bf1-c4");
            first = parser.parse();
        });
